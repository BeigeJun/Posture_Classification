...
# CSV 파일 저장 경로
csv_file = '/Users/wns20/PycharmProjects/SMART_CCTV/02.Use_CNN/Frames/keypoints_labels.csv'
...
with open(csv_file, mode='w', newline='') as file:
    ...
    # 루트 디렉토리
    root_dir = '/Users/wns20/PycharmProjects/SMART_CCTV/02.Use_CNN/Frames'
