...
first_mlp_model.load_state_dict(torch.load('/04.Four_MLP/Model/First_MLP.pth'))
class0_mlp_model.load_state_dict(torch.load('/04.Four_MLP/Model/Class0Model.pth'))
class1_mlp_model.load_state_dict(torch.load('/04.Four_MLP/Model/Class1Model.pth'))
class2_mlp_model.load_state_dict(torch.load('/04.Four_MLP/Model/Class2Model.pth'))
