...
first_mlp_model.load_state_dict(
    torch.load('/05. MLP_With_Angle/Model/MLP_Remove_Terrified_6Label.pth'))
...
# 비디오가 들어 있는 폴더 경로
video_folder = 'C:/Users/wns20/PycharmProjects/SMART_CCTV/05. MLP_With_Angle/5_5/TestVideo/Fall'
